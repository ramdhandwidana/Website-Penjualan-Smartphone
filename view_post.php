...
<body>
   ...
   <section class="view-post">
      ...
      <div class="heading">
         <h1>Detail Smartphone</h1> <a href="all_posts.php" class="inline-option-btn" style="margin-top: 0;">Kembali</a>
      </div>
      ...
      if ($select_post->rowCount() > 0) {
         while ($fetch_post = $select_post->fetch(PDO::FETCH_ASSOC)) {
            ...
            <div class="row">
               <div class="col">
                  <img src="uploaded_files/<?= $fetch_post['image']; ?>" height="20px" alt="" class="image">
                  <h3 class="title">
                     <?= $fetch_post['title']; ?>
                  </h3>
                  <h3>Range Harga :
               ...
               <div class="col">
                  <div class="flex">
                     <div class="total-reviews">
                        <h3>
                           <?= $average; ?><i class="fas fa-star"></i>
                        </h3>
                        <p>
                           <?= $total_reivews; ?> reviews
                        </p>
                     </div>
